...
- [ ] Phase 3 延后:real handler 接入(3.9a-3b2 WasmHandler + WasmHandlerExecutor + 真集群验证;async 基础已就绪)+ webhook(image_pushed;桌面架构冲突,可能跳过)。注:RUNS/EXPOSES 边已落地(见 Phase 3.9 条目);k8s-watch 已以 poll-diff 落地(见 PRD-003/002 后续条目),非 streaming watch
